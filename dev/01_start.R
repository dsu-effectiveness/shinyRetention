...
##
golem::fill_desc(
  pkg_name = "shinyRetention", # The Name of the package containing the App
  pkg_title = "Retention Exloration", # The Title of the package containing the App
  pkg_description = "A Shiny application, implemented as an R package, for exploring retention metrics.", # The Description of the package containing the App
  author_first_name = "", # Your First Name
  author_last_name = "", # Your Last Name
  author_email = "", # Your Email
  repo_url = "https://github.com/dsu-effectiveness/shinyRetention" # The URL of the GitHub Repo (optional)
)
